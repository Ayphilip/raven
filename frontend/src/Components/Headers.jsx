                ...
                <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
                    ...
                    <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <div id="logo">
                                <a href="/">
                                    <img src={Logo} alt="" class="w-28 md:block hidden dark:!hidden" />
                                    <img src={Logo} alt="" class="dark:md:block hidden" />
                                    <img src={Logo} class="hidden max-md:block w-20 dark:!hidden" alt="" />
                                    <img src={Logo} class="hidden dark:max-md:block w-20" alt="" />
                                </a>
                            </div>
                        ...
                        <div class="max-w-[1220px] mx-auto flex items-center">
                            ...
                            <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
                                ...
                                <div class="rounded-full relative bg-secondery cursor-pointer shrink-0">
                                    <img src={userDetails?.profilePicture ? avatars[parseInt(userDetails.profilePicture)] : avatars[0]} alt="" class="sm:w-9 sm:h-9 w-7 h-7 rounded-full shadow shrink-0" />
                                </div>
                                        ...
                                        // <a href={"/timeline/"+userDetails.username}>
                                            <div class="p-4 py-5 flex items-center gap-4">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="text-sm mt-1 text-blue-600 font-light dark:text-white/70">{userDetails.username}</div>
                                                </div>
                                            </div>
                                        // </a>
                                    }
