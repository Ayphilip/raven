...
function Sidbar({ ps }) {
    ...
    return (
        authenticate && <>
            <header class="sticky z-[100] h-[--m-top] fixed top-0 left-0 w-full flex items-center bg-white/80 sky-50 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 block md:hidden">
