    ...
    return (
        authenticate && <>
            ...
            <div>
                ...
                style={{maxWidth: window.innerWidth >= 1024 && '100px'}}
                    class="fixed top-0 z-[100] lg:w-max-[100px] transition-transform xl:duration-500 max-xl:w-[400px] max-xl:-translate-x-full">

                    <div style={{alignSelf: 'flex-end', alignItems: 'flex-end', alignContent: 'flex-end'}}>

                        <img src={Logo} style={{ width: window.innerWidth >= 1024 ? '100%' : '20%' }} />
