                                ...
                                <div class="bg-white shadow-sm md:p-4 p-2 space-y-4 text-sm font-medium border1 dark:bg-dark1">
                                    ...
                                    <div class="space-y-5 mt-3 p-2">
                                        <MentionsInput
                                            ...
                                            className="w-full !text-black placeholder:!text-black !bg-white !border-transparent focus:!border-transparent focus:!ring-transparent !font-small !text-xl dark:!text-white dark:placeholder:!text-white dark:!bg-slate-800"
