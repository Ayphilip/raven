                    ...
                    <div class="lg:flex 2xl:gap-16 gap-12 max-w-[1065px] mx-auto" id="js-oversized">
                        ...
                        <div class="max-w-[680px] mx-auto">
                            ...
                            <div class="md:max-w-[580px] mx-auto flex-1 xl:space-y-6 space-y-3">
                                ...
                                <div class="bg-white rounded-xl shadow-sm md:p-4 p-2 space-y-4 text-sm font-medium border1 dark:bg-dark2">
                                    ...
                                    <div class="p-5 flex justify-between items-center">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <button type="submit" onClick={saveTweet} class="button bg-blue-500 text-white py-2 px-12 text-[14px]"> Create</button>
                                        </div>
                                    </div>
                                ...
                                {tweets.map(tweet => <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6"
                                ...
                                <div class="box p-5 px-6">
                                    ...
                                    <div class="side-list">
                                        ...
                                        {users.filter(use => use.username !== userDetails.username).map(use => <div class="side-list-item">
                                            <a href="timeline.html">
                                                <img src={use?.profilePicture ? avatars[parseInt(use.profilePicture)] : avatars[0]} alt="" class="side-list-image rounded-full" />
                                            </a>
                                            <div class="flex-1">
                                                <a href="timeline.html"><h4 class="side-list-title">  {use.name} </h4></a>
